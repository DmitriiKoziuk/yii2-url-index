...
class UpdateEntityUrlFormTest extends Unit
{
    /**
     * @var UnitTester
     */
     ...
     */
    public function testValid($attributes)
    {
        $form = new UpdateEntityUrlForm($attributes);
     ...
     */
    public function testNotValidAttribute(string $attributeName, $attributeValue, string $attributeErrorMessage)
    {
        $form = new UpdateEntityUrlForm([$attributeName => $attributeValue]);
